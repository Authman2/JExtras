 ...
 * 	Date: April 19, 2016													*
 *  																		*
 *  Description: An image class. JEImage is just an easier way to load 		*
 *  BufferedImages into one's project. It has access to all of the same		*
 *  methods that BufferedImages do through the "getImage()" method, and 	*
 *  also extra methods for doing things specific to JEImages.				*
 *  																		*
 *  License: 																*
